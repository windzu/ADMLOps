...
class Anchor3DRangeGenerator(object):
    ...
    def anchors_single_range(
        self, feature_size, anchor_range, scale=1, sizes=[[3.9, 1.6, 1.56]], rotations=[0, 1.5707963], device="cuda"
    ):
...
class AlignedAnchor3DRangeGenerator(Anchor3DRangeGenerator):
    ...
    def anchors_single_range(
        self, feature_size, anchor_range, scale, sizes=[[3.9, 1.6, 1.56]], rotations=[0, 1.5707963], device="cuda"
    ):
        """Generate anchors in a single range.

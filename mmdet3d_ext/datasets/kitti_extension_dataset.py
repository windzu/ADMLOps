...
class KittiExtensionDataset(Custom3DDataset):
    r"""KITTI Extension Dataset.
    ...
    def get_data_info(self, index):
        ...
        # only_lidar 情况下，img_filename 为 None
        if self.only_lidar:
            img_filename = None
        else:
        ...
        # only_lidar 情况下，lidar2img 为 None
        if self.only_lidar:
            lidar2img = None
        else:
    ...
    def get_ann_info(self, index):
        ...
        # only_lidar 情况下 , gt_bboxes_3d 需要从camera坐标系转换到lidar坐标系
        if self.only_lidar:

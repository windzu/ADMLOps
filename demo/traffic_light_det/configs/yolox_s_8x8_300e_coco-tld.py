...
train_ann_file_list = [
    os.path.join(data_root, dataset, 'annotations', 'instances_train.json')
    for dataset in dataset_list
]
train_img_prefix_list = [
    os.path.join(data_root, dataset, 'train') for dataset in dataset_list
]

val_ann_file_list = [
    os.path.join(data_root, dataset, 'annotations', 'instances_val.json')
    for dataset in dataset_list
]
val_img_prefix_list = [
    os.path.join(data_root, dataset, 'val') for dataset in dataset_list
]

dataset_type = 'CocoDataset'
class_names = [
    'green_circle', 'green_arrow_left', 'green_arrow_straight',
    'green_arrow_right', 'red_circle', 'red_arrow_left', 'red_arrow_straight',
    'red_arrow_right', 'yellow_circle', 'yellow_arrow_left',
    'yellow_arrow_straight', 'yellow_arrow_right', 'off', 'unkown'
]
